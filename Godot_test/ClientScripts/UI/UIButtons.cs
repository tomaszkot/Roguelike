...
namespace UI
{
  ...
  {
    public static CheckButton autoCollectLoot = new CheckButton();

    public override void _Ready()
    {
      autoCollectLoot = (CheckButton)GetNode("%CheckAutoLoot");
    }
    ...
    private void _on_check_auto_loot_toggled(bool button_pressed)
    {
      if (button_pressed)
      {
        autoCollectLoot.Text = "Auto collect loot";
      }
      else
      {
        autoCollectLoot.Text = "Click G to collect";
      }
    }
  }

  ...
  public class LastingEffect
  {
    ...
    { 
      get 
      {
        ...
        return fi != null &&
          (
            fi.FightItemKind == Tiles.Looting.FightItemKind.HunterTrap ||
            fi.FightItemKind == Tiles.Looting.FightItemKind.WeightedNet
          );
      }  
    }
    ...
    public AbilityKind AbilityKind
    {
      get
      {
        if (LastingEffectSrc is AbilityLastingEffectSrc ale)
          return ale.AbilityKind;

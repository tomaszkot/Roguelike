  ...
  public class Looting
  {
    ...
    public Looting()
    {
      ...
      foreach (var lootSource in lootSourceKinds)
      {
        ...
        //DebugHelper.Assert(looting.ContainsKey(lootSource));
      }
    }
    ...
    public LootKind RollDiceForKind(LootSourceKind lsk, LootAbility ab)
    {
      ...
      //LootKind.Other
      var lk = chance.RollDice(LootKind.Unset, new LootKind[] { LootKind.Seal, LootKind.SealPart, LootKind.Book }, ab.ExtraChanceToAnyLoot);

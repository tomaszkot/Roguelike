...
namespace RoguelikeUnitTests
{
  ...
  class LocalizationTests : TestBase
  {
    ...
    public void TestHints()
    {
      ...
      hintHistory.SetKeyCode(Roguelike.Help.HintKind.LootCollectShortcut, (int)KeyCode.LeftAlt, (Roguelike.Help.HintKind hk) => { return KeyCode.LeftAlt.ToDescription(); });
      Assert.AreEqual(hint.Info, "Press 'Left Alt' to collect a single loot.");
